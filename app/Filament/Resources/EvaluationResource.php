    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Dados da Atividade')
                    ->description('Informações básicas sobre a Atividade')
                    ->icon('heroicon-o-clipboard-document-check')
                    ->schema([
                         Forms\Components\Section::make('Informações do Coodernador')
                            ->schema([
                                Forms\Components\TextInput::make('namecoordinator')
                                    ->label('Nome do coordenador')
                                    ->disabled()
                                    ->placeholder('-')
                                    ->afterStateHydrated(function ($component, $state, $record) {
                                        $component->state($record?->activity?->coordinator?->name);
                                    }),
                                Forms\Components\TextInput::make('emailcoo')
                                    ->label('Email')
                                    ->disabled()

                                    ->placeholder('-')
                                    ->afterStateHydrated(function ($component, $state, $record) {
                                        $component->state($record?->activity?->coordinator?->email);
                                    }),



                            ])
                            ->visible(fn($get, $record) => !empty($record?->activity?->coordenador_id))
                            ->columns(2),
                        ...
                        Forms\Components\Section::make('Informações do Estudante')
                            ->schema([
                                Forms\Components\TextInput::make('name')
                                    ...
                                    ->placeholder('-')
                                    ->afterStateHydrated(function ($component, $state, $record) {
                                        $component->state($record?->activity?->user?->name);
                                    }),
                            ...
                            ->schema([
                                Forms\Components\Select::make('activity_id')
                                    ...
                                    ->disabled(fn($record) => $record !== null),
                                     ...
                                     Forms\Components\TextInput::make('activity.description')
                                    ...
                                    ->afterStateHydrated(function ($component, $state, $record) {
                                       // dd($record->activity);
                                        $component->state($record?->activity?->description);
                                    })
                                    ->columnSpan(1),
