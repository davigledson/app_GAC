...
namespace App\Filament\Coodernador\Resources;

use App\Filament\Coodernador\Resources\ActivityCoorResource\Pages;
use App\Filament\Coodernador\Resources\ActivityCoorResource\RelationManagers;
...
class ActivityCoorResource extends Resource
{
...
->toggleable()
    ...
    {
        return [
            'index' => Pages\ListActivityCoors::route('/'),
            'create' => Pages\CreateActivityCoor::route('/create'),
            'edit' => Pages\EditActivityCoor::route('/{record}/edit'),
        ];
    }
}
