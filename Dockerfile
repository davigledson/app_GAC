...
# Gera chave da aplicação e cache de config/rotas (opcional: depende da existência de .env)
# Se o .env estiver incluso na build
RUN php artisan key:generate \
    && php artisan config:cache \
    && php artisan route:cache

# Inicia o Apache (default do php:apache já cuida disso)
